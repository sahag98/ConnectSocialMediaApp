        ...
        <div className='items-center justify-evenly md:justify-center flex h-screen w-full bg-[url("https://cdn.glitch.global/5288658f-8afb-4ac7-b1fa-300b8de8635f/Rectangle%2054%20(1).png?v=1672430722934")] bg-cover bg-center'>
            ...
            <div className='bg-white rounded-xl p-5 w-4/5 lg:w-1/4'>
                ...
                <form className='flex flex-col gap-4'>
                    <input className='rounded-xl bg-[#E7E7E7] p-3 outline-none' placeholder='Enter Email' type="text" />
                    <input className='rounded-xl bg-[#E7E7E7] p-3 outline-none' placeholder='Enter Full Name' type="text" />
                    ...
                    <button className='bg-[#313C3E] p-3 hover:bg-[#2b3536]  text-white rounded-md'>Sign Up</button>
                </form>
            </div>
        </div>
    )
